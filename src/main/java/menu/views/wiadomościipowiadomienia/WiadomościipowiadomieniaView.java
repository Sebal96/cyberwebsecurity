package menu.views.wiadomościipowiadomienia;
...
@PageTitle("Wiadomości i powiadomienia")
@Route(value = "wiadomosci", layout = MainLayout.class)
@PermitAll
public class WiadomościipowiadomieniaView extends HorizontalLayout {
    ...
    private ChatInfo[] chats = new ChatInfo[]{new ChatInfo("główny", 0), new ChatInfo("wsparcie", 0),
            new ChatInfo("informacje", 0)};
    private ChatInfo currentChat = chats[0];
    private Tabs tabs;

    public WiadomościipowiadomieniaView() {
        addClassNames("wiadomościipowiadomienia-view", Width.FULL, Display.FLEX, Flex.AUTO);
        setSpacing(false);
        ...
        UserInfo userInfo = new UserInfo(UUID.randomUUID().toString(), "Sebastian Lato");
